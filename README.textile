...
h2. Configure in Nginx + Passenger

If you want deploy on Nginx, you need compile nginx with "Nginx-Gridfs":https://github.com/mdirolf/nginx-gridfs module.

h2. Demo

"http://lanxs.com":http://lanxs.com
